...
public interface OrderMessage {
	...
	public static final String PLACE_ORDER_MESSAGE3 = "在您的店铺下单了，等待买家付款后即可发货。";// ok

	/** 买家支付成功 */
	public static final String PAID_MESSAGE = "在您的店铺购买的商品已经付款，请尽快发货哦！";// ?

	/** 卖家发货超时 */
	public static final String UNDELIVERED_MESSAGE1 = "由于卖家";
	public static final String UNDELIVERED_MESSAGE2 = "超时未发货，系统自动同意退款，现金";
	public static final String UNDELIVERED_MESSAGE3 = "元已成功退至支付账户，请注意查收";
	...
	/** 卖家发货 */
	public static final String DELIVER_MESSAGE = "您有一笔订单卖家已经发货，无需物流，注意检查包裹内容后再签收哦！";// ok
	public static final String DELIVER_MESSAGE1 = "您有一笔订单卖家已经发货，";// ok
	public static final String DELIVER_MESSAGE2 = "，运单号";
	public static final String DELIVER_MESSAGE3 = "。注意检查包裹内容后再签收哦！";// 读不通

	/** 确认收货 */
	public static final String CONFIRM_RECEIPT_MESSAGE = "在您的店铺购买的商品已经确认收货。";// ok
	...
	/** 评价 */
	public static final String CONFIRM_EVALUATE_MESSAGE1 = "在您的店铺购买的商品已经进行了评价。";// 评价没有切换数据库

	/** 申请退款 */
	public static final String APPLY_REFUND_MESSAGE1 = "您有一件商品申请了";
	public static final String APPLY_REFUND_MESSAGE2 = "，卖家将在";
	public static final String APPLY_REFUND_MESSAGE3 = "内进行处理，否则系统将自动同意退款。";
	public static final String APPLY_REFUND_MESSAGE4 = "在您店铺购买的商品申请了";
	public static final String APPLY_REFUND_MESSAGE5 = "，请在";
	public static final String APPLY_REFUND_MESSAGE6 = "内进行处理，否则系统将自动同意退款。";// ok

	/** 取消退款 */
	public static final String CANCEL_REFUND_MESSAGE = "在您店铺购买的商品取消了退款。";// ok
	...
	public static final String AGREE_REFUND_MESSAGE6 = "元已成功退至买家的支付账户。";// ok

	/** 卖家拒绝退款 */
	public static final String REFUSE_REFUND_MESSAGE1 = "卖家";
	public static final String REFUSE_REFUND_MESSAGE2 = "拒绝了您的退款，拒绝原因请查看退款详情。";// ok
	...
	/** 申请维权 */
	public static final String APPLY_ADULTS_MESSAGE1 = "您有一件商品申请了维权，卖家";
	...
	public static final String APPLY_ADULTS_MESSAGE4 = "在您店铺购买的商品申请了维权，请在";
	public static final String APPLY_ADULTS_MESSAGE5 = "内进行处理，否则官方将进行介入处理。";// ok

	/** 取消维权 */
	public static final String CANCEL_ADULTS_MESSAGE = "在您店铺购买的商品取消了维权。";// ok
	...
	public static final String OFFICAL_MANAGE_MESSAGE3 = "对您店铺商品发起的维权进行处理，处理结果请查看维权详情。";// ?

	/** 获得佣金 */
	public static final String GET_COMMISSION_MESSAGE1 = "您从一笔订单中获得的佣金80元，已经发放至您的钱包。";// ?

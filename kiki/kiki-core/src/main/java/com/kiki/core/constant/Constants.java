...
import com.kiki.core.common.PropertyConfigurer;
import com.kiki.core.framework.spring.context.utils.SpringContextUtil;
...
public interface Constants {
    ...
    interface HuanXinIM {
         ...
         */
        String ORG_NAME = "huangyaqing";

        /**
         * 同一”企业”下”app”唯一标识,开发者在环信开发者管理后台创建应用时填写的”应用名称”
         */
        String APP_NAME = "huangyaqingdetest";

        /**
         * app的client_id
         */
        String CLIENT_ID = "YXA6mHZ5YJ-HEeSY9EHDqelzcA";

        /**
         * app的client_secret
         */
        String CLIENT_SECRET = "YXA6Pii9fVfc0pV_UpDkD96G9WwZ_-0";

        /**
         * 请求注册URL
         */
        String HUANXIN_REQUEST_URL = "https://a1.easemob.com/" + ORG_NAME + "/" + APP_NAME;

        /**
         * 请求注册URL 后缀
         */
        String REGISTE_URL_SUFFIX = "/users";

        /**
         * 请求修改密码URL 后缀
         */
        String RESETPW_URL_SUFFIX = "/password";

        /**
         * 请求tokenURL 后缀
         */
        String TOKEN_URL_SUFFIX = "/token";

        /**
         * 请求注册URL Request Headers key
         */
        String REQUEST_HEADERS_KEY = "Authorization";

        /**
         * 请求注册URL Request Headers value
         */
        String REQUEST_HEADERS_VALUE = "Bearer ";

        /**
         * 请求类型 1为注册
         */
        Integer REGISTE_TYPE = 1;

        /**
         * 请求类型2为重置密码
         */
        Integer RESETPWD_TYPE = 2;

        /**
         * 请求类型3为重置昵称
         */
        Integer RESETNICKNAME_TYPE = 3;

        String SEND_MESSAGES = "/messages";

/**  
 * Project Name:easy-entity  
 * File Name:RYException.java  
 * Package Name:com.rongyi.easy.exception  
 * Date:2015年3月31日上午11:02:38  
 * Copyright (c) 2015, vipshop.com All Rights Reserved.  
 *  
*/  
...
public class RYServiceException extends RuntimeException {
   ...
   public RYServiceException(String description, IErrorCode errorCode) {
       this(description, errorCode, null);
   }
